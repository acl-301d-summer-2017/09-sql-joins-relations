...
const conString = 'postgres://fitzgerald@localhost:5432/kilovolt';// TODO: Don't forget to set your own conString
...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    // TODO for Pierre / John
    client.query(
      `INSERT INTO article (author_id, title, author, "authorUrl", category, "publishedOn", body) VALUES ($1, $2, $3, $4, $5, $6, $7)`, 
